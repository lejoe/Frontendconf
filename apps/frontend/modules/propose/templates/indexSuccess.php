<div class="row lastBeforeFooter">
    <div class="column grid_6">
        ...
        <fieldset>
            <legend>Your Talk:</legend>
            <label for="name">Talk title</label><br>
            <input type="text" name="name" class="maxWidth"><br>
            <label for="profession">Abstract</label><br>
            <textarea></textarea>
        </fieldset>
        ...
        <fieldset>
            ...
            <label for="name">Twitter-Name</label><br>
            <input type="text" name="name" class="maxWidth"><br>

            <label for="name">Your Website</label><br>
            <input type="text" name="name" class="maxWidth"><br>
        </fieldset>
        ...
        <fieldset>
            ...
            <input type="radio" name="preference" value="none"> Saturday <br>
